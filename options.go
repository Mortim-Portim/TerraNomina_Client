...
func (t *OptionsMenu) Init() {
	...
	recordButton, err := GetButton("checkbox", XRES*0.2, YRES*0.15, 0, 0, false)
	CheckErr(err)
	recordButton.Img.ScaleToOriginalSize()
	recordButton.Img.ScaleToY(TITLESCREEN_BUTTON_HEIGHT_REL * YRES)
	recordButton.DrawDark = RecordAll
